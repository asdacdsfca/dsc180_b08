...
class BERTMag7Classifier:
    def __init__(self, use_gpu=True):
        ...
        self.company_data = {
            ...
            'Amazon': ['amazon', 'amzn', 'aws', 'prime', 'bezos', 'jassy'],
            'Alphabet': ['alphabet', 'google', 'googl', 'goog', 'pichai', 'android', 'youtube'],
            ...
            'Tesla': ['tesla', 'tsla', 'musk', 'elon', 'ev', 'electric vehicle']
        }
        
        # Company aliases and alternate names
        self.company_aliases = {
            'Apple': ['apple inc', 'apple corporation', 'cupertino giant', 'iphone maker'],
            'Amazon': ['amazon.com', 'amazon inc', 'e-commerce giant'],
            'Alphabet': ['alphabet inc', 'google parent', 'search giant'],
            'Meta': ['meta platforms', 'facebook parent', 'social media giant'],
            'Microsoft': ['microsoft corporation', 'redmond giant', 'windows maker'],
            'Nvidia': ['nvidia corporation', 'chip maker', 'gpu giant'],
            'Tesla': ['tesla motors', 'tesla inc', 'ev maker', 'electric car company']
        }
    ...
    def get_mentioned_companies(self, text):
        ...
        chip_terms = ['semiconductor', 'chip', 'tsmc', 'intel', 'amd']
        ...
        # Semiconductor sector impacts Nvidia when AI is mentioned
        if ('Nvidia' not in mentioned and
            any(term in text_lower for term in chip_terms) and
            any(ai_term in text_lower for ai_term in ['ai', 'artificial intelligence', 'machine learning'])):
...
# Example usage
# Add this to the bottom of the example usage section
